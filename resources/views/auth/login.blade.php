        ...
        <div class="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-12 bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm">
            <div class="w-full max-w-md">
                <div class="text-center mb-10 lg:hidden">
                    ...
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-300">Atau <a href="{{ route('register') }}" class="font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300">daftar akun baru</a></p>
                </div>
    ...
    <div>
        ...
        <div class="relative">
            ...
            <input id="email" name="email" type="email" autocomplete="email" required
                ...
                class="form-input h-12 text-base pl-14 @error('email') border-red-300 @enderror"
    ...
    <div>
        ...
        <div class="relative">
            ...
            <input id="password" name="password" :type="showPassword ? 'text' : 'password'" autocomplete="current-password" required
                ...
                class="form-input h-12 text-base pl-14 pr-12 @error('password') border-red-300 @enderror"
                style="padding-left: 3.5rem !important;"
    ...
    <div>
        <button type="submit" :disabled="loading"
            ...
            <div class="absolute inset-0 bg-white opacity-0 group-hover:opacity-20 transition-opacity"></div>
                    ...
                    @include('auth.partials.social-login', ['label' => 'Atau lanjutkan dengan'])

                    <!-- Register Now CTA -->
                    <div class="mt-6 text-center text-sm text-gray-600 dark:text-gray-300">
                        Belum punya akun?
                        <a href="{{ route('register') }}" class="font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300">Daftar sekarang</a>
                    </div>
                </div>
                
                <div class="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
                    <p>© {{ date('Y') }} TodoList. Semua hak dilindungi.</p>
                    <p class="mt-2">
