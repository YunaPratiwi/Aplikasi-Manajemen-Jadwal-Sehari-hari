            ...
            <div class="w-full max-w-md">
                <div class="text-center mb-10 lg:hidden">
                    ...
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-300">
                        Sudah punya akun?
                        <a href="<?php echo e(route('login')); ?>" class="font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300">
                            Masuk di sini
                        </a>
                    </p>
                </div>
                ...
                <div class="card p-8 shadow-xl border border-gray-100 dark:border-gray-700 rounded-2xl">
                    ...
                    <form x-data="registerForm()" @submit="handleSubmit" class="space-y-6" action="<?php echo e(route('register')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="text-center mt-4">
                            <a href="<?php echo e(route('login')); ?>" class="text-sm font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300 transition">
                                ← Kembali ke Login
                            </a>
                        </div>
                    </form>
                ...
                <p class="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
                    © <?php echo e(date('Y')); ?> TodoList. Semua hak dilindungi.
                </p>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\TODOLIST\TODOLIST\resources\views/auth/register.blade.php ENDPATH**/ ?>