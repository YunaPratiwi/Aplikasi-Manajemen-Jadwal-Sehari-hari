...
<html lang="id" class="h-full" x-data="{ 
    ...
    sidebarOpen: false,
    searchOpen: false,
    notifications: <?php echo json_encode(session()->get('notifications', []), 512) ?>,
    loading: false,
    searchQuery: '',
    ...
    <?php if(session()->has('success')): ?>
        notifications.push({ id: Date.now(), type: 'success', message: '<?php echo e(session('success')); ?>' });
    <?php endif; ?>
    <?php if(session()->has('error')): ?>
        notifications.push({ id: Date.now(), type: 'error', message: '<?php echo e(session('error')); ?>' });
    <?php endif; ?>
    // Keyboard shortcuts
...
<head>
    ...
    <meta name="description" content="<?php echo e($description ?? 'Kelola tugas Anda dengan efisien menggunakan TodoList'); ?>">
    <meta name="keywords" content="todo, tugas, produktivitas, manajemen">
    <meta name="author" content="TodoList">
    <meta property="og:title" content="<?php echo e($title ?? 'TODOLIST'); ?>">
    <meta property="og:description" content="<?php echo e($description ?? 'Kelola tugas Anda dengan efisien menggunakan TodoList'); ?>">
    <meta property="og:type" content="website">
    <title><?php echo e($title ?? 'TODOLIST'); ?></title>
        ...
        <aside x-show="sidebarOpen" x-transition:enter="transition-all duration-300 ease-out"
            ...
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                    <a href="<?php echo e(route('dashboard')); ?>" class="group flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all <?php echo e(request()->routeIs('dashboard') ? 'bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 text-blue-700 dark:text-blue-300 shadow-sm' : 'text-slate-700 hover:text-slate-900 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800'); ?>">
                        <div class="relative">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                            </svg>
                            <div x-show="<?php echo e(request()->routeIs('dashboard')); ?>" class="absolute -inset-1 bg-blue-500 rounded-lg opacity-20 blur-sm"></div>
                        </div>
                        <span>Dashboard</span>
                        <span x-show="<?php echo e(request()->routeIs('dashboard')); ?>" class="ml-auto w-2 h-2 bg-blue-500 rounded-full"></span>
                    </a>
                    <a href="<?php echo e(route('tasks.index')); ?>" class="group flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all <?php echo e(request()->routeIs('tasks.*') ? 'bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 text-blue-700 dark:text-blue-300 shadow-sm' : 'text-slate-700 hover:text-slate-900 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800'); ?>">
                        <div class="relative">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                            </svg>
                            <div x-show="<?php echo e(request()->routeIs('tasks.*')); ?>" class="absolute -inset-1 bg-blue-500 rounded-lg opacity-20 blur-sm"></div>
                        </div>
                        <span>Tasks</span>
                        <span x-show="<?php echo e(request()->routeIs('tasks.*')); ?>" class="ml-auto w-2 h-2 bg-blue-500 rounded-full"></span>
                    </a>
                    <a href="<?php echo e(route('categories.index')); ?>" class="group flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all <?php echo e(request()->routeIs('categories.*') ? 'bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 text-blue-700 dark:text-blue-300 shadow-sm' : 'text-slate-700 hover:text-slate-900 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800'); ?>">
                        <div class="relative">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path>
                            </svg>
                            <div x-show="<?php echo e(request()->routeIs('categories.*')); ?>" class="absolute -inset-1 bg-blue-500 rounded-lg opacity-20 blur-sm"></div>
                        </div>
                        <span>Categories</span>
                        <span x-show="<?php echo e(request()->routeIs('categories.*')); ?>" class="ml-auto w-2 h-2 bg-blue-500 rounded-full"></span>
                    </a>
                    <a href="<?php echo e(route('archive.tasks')); ?>" class="group flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all <?php echo e(request()->routeIs('archive.*') ? 'bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 text-blue-700 dark:text-blue-300 shadow-sm' : 'text-slate-700 hover:text-slate-900 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800'); ?>">
                        <div class="relative">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"></path>
                            </svg>
                            <div x-show="<?php echo e(request()->routeIs('archive.*')); ?>" class="absolute -inset-1 bg-blue-500 rounded-lg opacity-20 blur-sm"></div>
                        </div>
                        <span>Archive</span>
                        <span x-show="<?php echo e(request()->routeIs('archive.*')); ?>" class="ml-auto w-2 h-2 bg-blue-500 rounded-full"></span>
                    </a>
                    ...
                    <div class="pt-6 mt-6 border-t border-slate-200/60 dark:border-slate-700/60">
                        ...
                        <a href="<?php echo e(route('profile.show')); ?>" class="group flex items-center gap-3 px-4 py-3 mt-3 rounded-xl text-sm font-medium text-slate-700 hover:text-slate-900 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                            </svg>
                            <span>Profile</span>
                        </a>
                        <a href="<?php echo e(route('settings.index')); ?>" class="group flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium text-slate-700 hover:text-slate-900 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="p-6 border-t border-slate-200/60 dark:border-slate-700/60">
                    <div class="flex items-center gap-3 p-3 rounded-xl bg-gradient-to-r from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-700">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium text-slate-900 dark:text-white truncate"><?php echo e(auth()->user()->name); ?></p>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="relative" x-data="{ open: false }">
                                <button @click="open = !open" class="group flex items-center gap-2 p-2.5 rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 transition-all duration-200 shadow-md hover:shadow-lg">
                                    ...
                                    <span class="hidden md:inline text-sm font-medium text-white"><?php echo e(auth()->user()->name); ?></span>
                                ...
                                <div x-show="open" @click.away="open = false" x-transition:enter="transition ease-out duration-200"
                                     ...
                                     style="display: none;">
                                    <div class="px-4 py-3 border-b border-slate-200/60 dark:border-slate-700/60">
                                        <p class="text-sm font-semibold text-slate-900 dark:text-white"><?php echo e(auth()->user()->name); ?></p>
                                        <p class="text-xs text-slate-500 dark:text-slate-400"><?php echo e(auth()->user()->email); ?></p>
                                    </div>
                                    <a href="<?php echo e(route('profile.show')); ?>" class="flex items-center gap-3 px-4 py-3 text-sm text-slate-700 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800/50 transition-colors">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                                        </svg>
                                        Profile
                                    </a>
                                    <a href="<?php echo e(route('settings.index')); ?>" class="flex items-center gap-3 px-4 py-3 text-sm text-slate-700 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800/50 transition-colors">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"></path>
                                        </svg>
                                        Settings
                    ...
                    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-3">
                        <nav class="flex" aria-label="Breadcrumb">
                            <ol class="flex items-center space-x-2 text-sm">
                                <li>
                                    <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-300 transition-colors">
                                    ...
                                    <li>
                                        <div class="flex items-center">
                                            ...
                                            <?php if($index === count($breadcrumbs) - 1): ?>
                                                <span class="ml-2 font-medium text-slate-900 dark:text-white"><?php echo e($breadcrumb['title']); ?></span>
                                            <?php else: ?>
                                                <a href="<?php echo e($breadcrumb['url'] ?? '#'); ?>" class="ml-2 text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-300 transition-colors"><?php echo e($breadcrumb['title']); ?></a>
                                            <?php endif; ?>
                                        </div>
                                    </li>
                ...
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
                    <div class="flex flex-col md:flex-row justify-between items-center">
                        <div class="text-sm text-slate-500 dark:text-slate-400">
                            &copy; <?php echo e(date('Y')); ?> TodoList. All rights reserved.
                        </div>
                ...
                <div class="bg-white dark:bg-slate-900 px-6 pt-6 pb-4 sm:p-6">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <a href="<?php echo e(route('tasks.create')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm text-slate-700 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800/50 transition-all group">
                            ...
                            <a href="<?php echo e(route('categories.create')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm text-slate-700 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800/50 transition-all group">
...
</html><?php /**PATH C:\xampp\htdocs\TODOLIST (2)\TODOLIST\TODOLIST\resources\views/layouts/app.blade.php ENDPATH**/ ?>